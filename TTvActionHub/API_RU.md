...
| tevents         | `lua-table` | Таблица    | Таблица, содержащая в себе определения пользовательских [событий](#временные-события), срабатывающих по таймеру | +           | `null`               |
...
Таблица tevents содержит определения ваших пользовательских событий. Каждый ключ в этой таблице представляет собой имя события (которое вы указали в панели твича). Значение, связанное с именем каждого события, представляет собой другую таблицу, содержащую следующие ключи

...
public partial class LuaKeyboard
{
    ...
    public static void PressKey(int key)
    {
        lock (_inputLock)
        {
            wrapper.KeyDown((KeyCodes)key).SendInputs();
        }
    }
    ...
    public static void ReleaseKey(int key)
    {
        lock (_inputLock)
        {
            wrapper.KeyUp((KeyCodes)key).SendInputs();
        }
    }
    ...
    public static void TypeKey(int key)
    {
        lock (_inputLock)
        {
            wrapper.KeyType((KeyCodes)key).SendInputs();
        }
    }
    ...
    public static void TypeMessage(string message)
    {
        lock (_inputLock)
        {
            wrapper.TypeString(message).SendInputs();
        }
    }
